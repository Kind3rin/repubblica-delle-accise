...
const APP_NAME = "Repubblica delle Accise — Il comune sei tu";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Costruisci il tuo piccolo comune, raccogli petrolio e guida il tuo esercito di Vespe. Un gioco strategico, una grande satira italiana.",
      },
      { name: "theme-color", content: "#193e31" },
    ],
    links: [
